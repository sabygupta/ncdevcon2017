...
public class SwaggerDocumentationConfig {
	...
	ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Swagger Petstore")
				.description(
	...
	public Docket customImplementation() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				...
				//.apis(Predicates.or(RequestHandlerSelectors.basePackage("io.swagger.api"),
				//		RequestHandlerSelectors.basePackage("com.restapi.controller")))
